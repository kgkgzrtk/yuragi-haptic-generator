...
class TestSignalPipeline:
    ...
    def test_channel_with_resonator_exists(self):
        ...
        assert hasattr(
            channel, "enable_resonator"
        ), "Channel should have resonator control"
    ...
    def test_channel_integrated_processing(self):
        ...
        channel.set_parameters(frequency=30, amplitude=1.0, phase=0, polarity=True)
        ...
        assert (
            resonance_found
        ), f"No significant content near 180Hz resonance. Found peaks at: {significant_freqs[significant_freqs > 20]}"
