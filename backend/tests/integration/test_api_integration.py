...
class TestParametersAPI:
    ...
    def test_update_parameters(self, client):
        ...
        new_params = {
            "channels": [
                {"channel_id": 0, "frequency": 60.0, "amplitude": 0.5, "phase": 0.0, "polarity": True},
                {"channel_id": 1, "frequency": 70.0, "amplitude": 0.6, "phase": 90.0, "polarity": True},
                {"channel_id": 2, "frequency": 80.0, "amplitude": 0.7, "phase": 180.0, "polarity": False},
                {"channel_id": 3, "frequency": 90.0, "amplitude": 0.8, "phase": 270.0, "polarity": False}
            ]
        }
