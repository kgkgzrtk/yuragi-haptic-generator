...
class TestYuragiPresetAPI:
    ...
    def test_all_preset_types_have_required_fields(self, client):
        ...
        for preset_name in presets:
            ...
            for field in required_fields:
                ...
                assert isinstance(params[field], (int, float)), f"Field {field} should be numeric in preset {preset_name}"
    ...
    def test_preset_specific_values(self, client):
        """各プリセットの具体的な値を検証"""
        expected_presets = {
            "default": {"angle": 0.0, "magnitude": 0.7, "frequency": 60.0, "rotation_freq": 0.33},
            "gentle": {"angle": 45.0, "magnitude": 0.4, "frequency": 40.0, "rotation_freq": 0.2},
            "strong": {"angle": 90.0, "magnitude": 1.0, "frequency": 80.0, "rotation_freq": 0.5},
            "slow": {"angle": 180.0, "magnitude": 0.8, "frequency": 25.0, "rotation_freq": 0.15}
        }
